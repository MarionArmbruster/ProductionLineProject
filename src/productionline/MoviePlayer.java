...
public class MoviePlayer extends Product implements MultimediaControl {
   ...
   * in addition to the local monitor type instance variable and a call to the toString method in
   * class Screen (which displays the information specific to that class as well).
   */
